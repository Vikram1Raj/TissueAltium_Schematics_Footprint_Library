# My Altium Master Library Collection

This is my personal repository for Altium Designer components. All parts are organized by category and include 3D models.

The library is split into functional categories to keep the design workspace clean.

## 📦 How to Use
1. Clone this repository or download the latest `.IntLib` file from `Project Outputs for TissueAltium_Schematic_Footprints` 
...
> ### 🧱 3D Model Credits
> None of the 3D models were made by me; they were obtained from various open-source CAD websites.
